  ...
  return (
    <div className='w-[18%] min-h-screen border-r-2 border-gray-200 bg-white'>
      <div className='flex flex-col gap-4 pt-6 pl-[20%] text-[15px]'>
        ...
        <NavLink 
            to="/add" 
            className={({ isActive }) => `flex items-center gap-3 border border-r-0 px-3 py-2 rounded-l transition-all ${isActive ? 'active' : 'border-transparent text-gray-600 hover:bg-gray-50'}`}
        >
